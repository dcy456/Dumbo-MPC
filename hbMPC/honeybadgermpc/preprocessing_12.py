...
class PreProcessingMixin(ABC):
    ...
    def __init__(self, field, poly, data_dir):
        ...
        print("listdir(self.data_dir)", listdir(self.data_dir))
        self._refresh_cache()
    ...
    def _read_preprocessing_file(self, file_name):
        ...
        with open(file_name, "r") as f:
            ...
            values = list(map(int, filter(lambda x: x.strip(), lines)))
    ...
    def _write_preprocessing_file(
        ...
        if append:
            with open(file_name, "r") as f:
                ...
                meta = tuple(int(line.strip()) for line in (f.readline() for _ in range(3)) if line.strip())
...
class PreProcessedElements:
    ...
    def preprocessing_done(self):
        ...
        """
        # print(self._ready_file)
        # directory = os.path.dirname(self._ready_file)
