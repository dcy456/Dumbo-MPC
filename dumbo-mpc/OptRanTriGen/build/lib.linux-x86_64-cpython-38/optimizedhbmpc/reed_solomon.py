from optimizedhbmpc.ntl import vandermonde_batch_evaluate, vandermonde_batch_interpolate
from optimizedhbmpc.ntl import gao_interpolate
from optimizedhbmpc.ntl import (
    fft,
    fft_interpolate,
...
from optimizedhbmpc.reed_solomon_wb import make_wb_encoder_decoder
...
class DecodeValidationError(OptimizedhbmpcError):
    pass
    ...
    def _optimistic_update(self, idx, data):
        ...
        if len(self._available_points) == self.degree + 1:
            ...
            if success is False:
                ...
                print("Optimistic decoding failed")
                self._guess_decoded = None
                self._guess_encoded = None
