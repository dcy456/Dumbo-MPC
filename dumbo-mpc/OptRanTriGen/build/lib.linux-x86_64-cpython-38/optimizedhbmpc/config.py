"""
Module for ``optimizedhbmpc``'s configuration.
...
import json
from optimizedhbmpc.reed_solomon import Algorithm as RSAlgorithm
...
class ReconstructionConfig(object):
    ...
    def from_json(cls, json_config):
        ...
        if "decoding_algorithm" in json_config:
            ...
            assert decoding_algorithm in decoding_algorithms, f"decoding_algorithm must be in {decoding_algorithms}"
            # assert (
