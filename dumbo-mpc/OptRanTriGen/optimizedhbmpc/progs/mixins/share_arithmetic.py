from optimizedhbmpc.progs.mixins.base import AsyncMixin
from optimizedhbmpc.progs.mixins.constants import MixinConstants
from optimizedhbmpc.utils.typecheck import TypeCheck
from optimizedhbmpc.progs.mixins.dataflow import Share, ShareArray
from optimizedhbmpc.field import GFElement

from asyncio import gather


class BeaverMultiply(AsyncMixin):
    from optimizedhbmpc.mpc import Mpc, Share
