...
from beaver.utils.misc import print_exception_callback
...
async def test_mpc_programs(peers, n, t, my_id):
    from beaver.mpc import test_prog1, test_prog2, test_batchopening
    from beaver.preprocessing import PreProcessedElements
    from beaver.preprocessing import wait_for_preprocessing, preprocessing_done
