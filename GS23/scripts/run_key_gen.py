...
lib.pySRSGen.argtypes = [c_int]
lib.pySRSGen.restype = c_char_p
...
def trusted_key_gen(n, basis_size):

    # Generate avss params
    SRS = lib.pySRSGen(basis_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batchsize', metavar='batchsize', required=True,
    ...
    SRS, pks_acss, sk_acss = trusted_key_gen(N, batchsize)
